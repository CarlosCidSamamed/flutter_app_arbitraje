...
class LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    ]); // Bloquear la orientación de la pantalla a horizontal y sin invertir.
    auth.getUser.then(
      (user) {
        if (user != null) {
  ...
  bool checkScreenSize() {
    ...
    if (MediaQuery.of(context).size.width < 500) {
      ...
      SystemChrome.setPreferredOrientations([
        DeviceOrientation.landscapeLeft,
      ]); // Bloquear la orientación de la pantalla a horiznotal y sin invertir.
      res = true;
    }
    return res;
  }
